...
use calcium_rendering_2d::render_data::{RenderData, RenderBatch, ShaderMode, Rectangle, RenderSet, Projection, UvMode};
...
impl<R: RendererRaw> BackgroundView<R> {
    ...
    pub fn render(&self, render_data: &mut RenderData<R>, renderer: &mut Renderer<R>) {
        ...
        background_batch.push_rectangle_full_texture(Rectangle::new(
