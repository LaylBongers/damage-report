...
impl Renderer {
    ...
    pub fn build_lighting_command_buffer(
        ...
        let set = Arc::new(simple_descriptor_set!(self.lighting_pipeline.clone(), 0, {
            u_gbuffer_position: (
                self.geometry_buffer.position_attachment.clone(), self.geometry_renderer.sampler.clone()
            ),
            u_gbuffer_base_color: (
                self.geometry_buffer.base_color_attachment.clone(), self.geometry_renderer.sampler.clone()
            ),
            u_gbuffer_normal: (
                self.geometry_buffer.normal_attachment.clone(), self.geometry_renderer.sampler.clone()
            ),
            u_gbuffer_roughness: (
                self.geometry_buffer.roughness_attachment.clone(), self.geometry_renderer.sampler.clone()
            ),
            u_gbuffer_metallic: (
                self.geometry_buffer.metallic_attachment.clone(), self.geometry_renderer.sampler.clone()
            ),
